...
from .forms import BlogPostModelForm, PartnerModelForm, StockModelForm, ProductModelForm, DealModelForm, DealProductModelForm, ReportModelForm, ReportDateForm, SignatureFileForm
from .models import BlogPost, Partner, Stock, Product, Deal, DealProduct, DealType

from blog.classes.report import collect_data_for_report
from blog.classes.utils import generate_report
from blog.classes.verify_signature import verify_signature
...
def deal_create_view(request):
    ...
    if form.is_valid():
        ...
        obj.save()
        return redirect("/blog/deal/{0}/new-product/".format(obj.id))
    context = {'form': form}
    return render(request, template_name, context)
...
def deal_product_create_view(request, id):
    ...
    if form.is_valid():
        ...
        obj.save()
        return redirect("/blog/deal/{0}/new-product/".format(id))
